...
class inmet_gov_br_tempSpider(Spider):
    name = "inmet_gov_br_temp"
    ...
    def parse(self, response):
        ...
        for m, id_val in enumerate(self.ids):
            ...
            data = self.driver.page_source.split('Estacao;Data;Hora;Temp Comp Media;')[-1].split('</pre>')[0].split('\n')

            if 'Estacao;Data;Hora;Temp Comp Media;' not in self.driver.page_source:
                print('\n########################################')
